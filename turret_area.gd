...
# This code was fetched from Neal Holtschulte's tutorial on turret tracking

# His code is loosely based on code from here:
# https://github.com/IndieQuest/ModularTurret/tree/master/src
# https://www.youtube.com/watch?v=4IS9zIVCDKc&ab_channel=IndieQuest
# but modified by him, Neal Holtschulte in 2024 because
...
@onready var body: Node3D = $"../TurretMesh/TurretBody/TurretHead"  # Component to be rotated
@onready var head: Node3D = $"../TurretMesh/TurretBody" # Component to be elevated
